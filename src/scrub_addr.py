...
#class NERModel:
  ...
  def testTheModel(self,test_data_file,data_only=False):
...
if __name__ == "__main__":
  ...
  #nerModel = NERModel("numModel","train.txt","../data/addr/")
  #nerModel.trainTheModel()
  #nerModel.loadModel('ner_model_numModel.tfl')
  nerModel.loadModel('ner_model_1stmodel.tfl')
